...
let arrLang = {
  'en': {
    ...
    'contact': 'Contact',
    // 第一層
    "opp-header": 'The opportunity for Taiwanese youth',
    ...
    "form-consult": 'Personal Consultation',
    "form-application": 'Filling Application',
    ...
    "speech-content": 'Book Davis for your next high school, elementary, college speech.',
    "location-1": 'PCSH',
    "location-2": 'PCSH',
    "location-3": 'PCSH',
    "location-4": 'PCSH',
  ...
  'zh': {
    ...
    'contact': '立即申請',
    // 第一層
    "opp-header": '台灣青少年的嶄新機會',
    "opp-content": '相信我能帶領著孩子們，透過運動和教育，體驗更多精彩的海外旅程！',
    // 第二層
    "qd-header": '戴維斯 III',
